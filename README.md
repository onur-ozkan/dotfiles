...
- `nixos/overlays/suckless.nix`: overlay that builds `dwm`, `st`, `dmenu`, `dwmblocks`, `slock`, and `sbs` from the GitHub forks.
- `nixos/home/default.nix`: Home Manager module that ships all dotfiles in this repository.
