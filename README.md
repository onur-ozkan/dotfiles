...
3. Generate a hardware profile for the machine and overwrite the placeholder:
   ...
   ```
4. Adjust host/user details in `nixos/hosts/nimda/configuration.nix` or `home/default.nix` if needed. Toggle laptop/Bluetooth features via `nimda.profile` in the host file.
